...
const tool = getLocalizedTool("json-to-java", DEFAULT_LOCALE)!;
const content = getToolContent(DEFAULT_LOCALE, "json-to-java");
const ToolComponent = getToolComponent("json-to-java")!;
