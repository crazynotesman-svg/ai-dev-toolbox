...
const tool = getLocalizedTool("json-to-typescript", DEFAULT_LOCALE)!;
const content = getToolContent(DEFAULT_LOCALE, "json-to-typescript");
const ToolComponent = getToolComponent("json-to-typescript")!;
