...
const tool = getLocalizedTool("json-explain", DEFAULT_LOCALE)!;
const content = getToolContent(DEFAULT_LOCALE, "json-explain");
const ToolComponent = getToolComponent("json-explain")!;
